package com.shervinfirouzdehghan.flashchatnewfirebase;
...
public class ChatListAdapter extends BaseAdapter {
    ...
    //Special constructor that acceps an activity the rreference to the database were you stored the data and the username of the person that sent the message
    ...
    //Returns the size of the array list which is automatically updated
    @Override
    public int getCount() {
